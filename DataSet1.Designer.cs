...
namespace Okul_OrnekProje {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class NotlarDataTable : global::System.Data.TypedTableBase<NotlarRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NotlarRow AddNotlarRow(DerslerRow parentDerslerRowByFK_Notlar_Dersler, int OgrID, byte Sinav1, byte Sinav2, byte Sinav3, byte Proje, decimal Ortalama, int Durum) {
        ...
        public partial class NotlarRow : global::System.Data.DataRow {
            ...
            public int Durum {
                get {
                    try {
                        return ((int)(this[this.tableNotlar.DurumColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace Okul_OrnekProje.DataSet1TableAdapters {
    ...
    public partial class DerslerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Okul_OrnekProje.Properties.Settings.Default.OkulProjeConnectionString;
        }
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Ogrenciler.OgrID, Ogrenciler.OgrAd, Ogrenciler.OgrSoyad, Kulupler.KulupAd," +
                " Ogrenciler.OgrCinsiyet\r\nFROM     Ogrenciler INNER JOIN\r\n                  Kulup" +
                "ler ON Ogrenciler.OgrKulup = Kulupler.KulupID";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Ogrenciler.OgrID, Ogrenciler.OgrAd, Ogrenciler.OgrSoyad, Kulupler.KulupAd," +
                " Ogrenciler.OgrCinsiyet\r\nFROM     Ogrenciler INNER JOIN\r\n                  Kulup" +
                "ler ON Ogrenciler.OgrKulup = Kulupler.KulupID\r\nwhere OgrAd=@OgrAd";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
...
SELECT NotID, DersID, OgrID, Sinav1, Sinav2, Sinav3, Proje, Ortalama, Durum FROM Notlar WHERE (NotID = @NotID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "UPDATE [Notlar] SET [DersID] = @DersID, [OgrID] = @OgrID, [Sinav1] = @Sinav1, [Si" +
                "nav2] = @Sinav2, [Sinav3] = @Sinav3, [Proje] = @Proje, [Ortalama] = @Ortalama, [" +
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Durum", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Durum", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_NotID, global::System.Nullable<byte> Original_DersID, global::System.Nullable<int> Original_OgrID, global::System.Nullable<byte> Original_Sinav1, global::System.Nullable<byte> Original_Sinav2, global::System.Nullable<byte> Original_Sinav3, global::System.Nullable<byte> Original_Proje, global::System.Nullable<decimal> Original_Ortalama, global::System.Nullable<int> Original_Durum) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(global::System.Nullable<byte> DersID, global::System.Nullable<int> OgrID, global::System.Nullable<byte> Sinav1, global::System.Nullable<byte> Sinav2, global::System.Nullable<byte> Sinav3, global::System.Nullable<byte> Proje, global::System.Nullable<decimal> Ortalama, global::System.Nullable<int> Durum) {
            ...
            if ((Durum.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[7].Value = ((int)(Durum.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((Durum.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Durum.Value));
            }
            else {
            ...
            if ((Original_Durum.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[24].Value = ((int)(Original_Durum.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int NotGuncelle(global::System.Nullable<byte> DersID, global::System.Nullable<int> OgrID, global::System.Nullable<byte> Sinav1, global::System.Nullable<byte> Sinav2, global::System.Nullable<byte> Sinav3, global::System.Nullable<byte> Proje, global::System.Nullable<decimal> Ortalama, global::System.Nullable<int> Durum, int Original_NotID) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((DersID.HasValue == true)) {
            ...
            if ((Durum.HasValue == true)) {
                command.Parameters[7].Value = ((int)(Durum.Value));
            }
            else {
